...
import * as _i_out from "../../../../../interface/generated/pareto/schemas/sealed_ast/data_types/target"
import * as _i_r_token from "../token/unmarshall"
import * as _i_signatures from "../../../../../interface/generated/pareto/schemas/sealed_ast/unmarshall"
...
export const Value: _i_signatures._T_Value = ($, $p) => _i_generic.process_unconstrained_state_group(
    $,
    {
        'states': _pa.dictionary_literal({
            'indexed collection': ($): _i_out._T_Value.SG => ['indexed collection', _i_generic.process_unconstrained_state_group(
                $,
                {
                    'states': _pa.dictionary_literal({
                        'dictionary': ($): _i_out._T_Value.SG.indexed_collection.SG => ['dictionary', _i_generic.process_group(
                            $,
                            {
                                'properties': ($) => ({
                        ...
                        'verbose group': ($): _i_out._T_Value.SG.indexed_collection.SG => ['verbose group', _i_generic.process_group(
                            $,
                            {
                                'properties': ($) => ({
                                    '(': _pa.cc(_i_generic.get_entry(
            ...
            'not set': ($): _i_out._T_Value.SG => ['not set', _i_generic.process_group(
                $,
                {
                    'properties': ($) => ({
                        '~': _pa.cc(_i_generic.get_entry(
            ...
            'ordered collection': ($): _i_out._T_Value.SG => ['ordered collection', _i_generic.process_unconstrained_state_group(
                $,
                {
                    'states': _pa.dictionary_literal({
                        'concise group': ($): _i_out._T_Value.SG.ordered_collection.SG => ['concise group', _i_generic.process_group(
                            $,
                            {
                                'properties': ($) => ({
                                    '<': _pa.cc(_i_generic.get_entry(
                        ...
                        'list': ($): _i_out._T_Value.SG.ordered_collection.SG => ['list', _i_generic.process_group(
                            $,
                            {
                                'properties': ($) => ({
                                    '[': _pa.cc(_i_generic.get_entry(
            ...
            'set optional value': ($): _i_out._T_Value.SG => ['set optional value', _i_generic.process_group(
                $,
                {
                    'properties': ($) => ({
                        '*': _pa.cc(_i_generic.get_entry(
            ...
            'string': ($): _i_out._T_Value.SG => ['string', String(
                $,
                {
                    'value deserializers': $p['value deserializers'],
                }
            )],
            'tagged value': ($): _i_out._T_Value.SG => ['tagged value', _i_generic.process_group(
                $,
                {
                    'properties': ($) => ({
