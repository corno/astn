...
export const Value: t_signatures.Value = ($,) => ({
    ...
    'data': _p.deprecated_cc($['data'], ($,) => _p.decide.state($, ($,): t_out.Value.data => {
        switch ($[0]) {
            case 'missing':
                return _p.ss($, ($,) => ['missing', null])
            case 'include':
                return _p.ss($, ($,) => ['include', ({
                    'path': _p.deprecated_cc($['path'], ($,) => $),
                })])
            case 'concrete':
                return _p.ss($, ($,) => ['concrete', ({
                    'type': _p.deprecated_cc($['type'], ($,) => _p.decide.state($, ($,): t_out.Value.data.concrete.type_ => {
                        switch ($[0]) {
                            ...
                            case 'optional':
                                return _p.ss($, ($,) => ['optional', _p.decide.state($, ($,): t_out.Value.data.concrete.type_.optional => {
                                    switch ($[0]) {
                                        case 'not set':
                                            return _p.ss($, ($,) => ['not set', null])
                                        case 'set':
                                            return _p.ss($, ($,) => ['set', Value($)])
                                        default:
                                            return _p.au($[0])
                                    }
                                })])
                            case 'state':
                                return _p.ss($, ($,) => ['state', _p.decide.state($, ($,): t_out.Value.data.concrete.type_.state => {
                                    switch ($[0]) {
                                        case 'missing data':
                                            return _p.ss($, ($,) => ['missing data', null])
                                        case 'set':
                                            return _p.ss($, ($,) => ['set', ({
                            ...
                            case 'text':
                                return _p.ss($, ($,) => ['text', ({
                                    ...
                                    'delimiter': _p.deprecated_cc($['delimiter'], ($,) => _p.decide.state($, ($,): t_out.Value.data.concrete.type_.text.delimiter => {
                                        switch ($[0]) {
                                            case 'none':
