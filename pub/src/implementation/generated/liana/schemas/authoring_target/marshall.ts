...
export const Value: t_signatures.Value = ($,) => ['group', ['verbose', _p.dictionary.literal(({
    'metadata': _p.deprecated_cc($['metadata'], ($,) => ['group', ['verbose', _p.dictionary.literal(({
        'comments': _p.deprecated_cc($['comments'], ($,) => ['list', $.__l_map(($,) => ['text', ({
            'delimiter': ['quote', null],
            'value': $,
        })])]),
    }))]]),
    'data': _p.deprecated_cc($['data'], ($,) => ['state', _p.decide.state($, ($,): t_out.Value.state => {
        switch ($[0]) {
            case 'missing':
                return _p.ss($, ($,) => ({
                    'option': "missing",
                        ...
                        'type': _p.deprecated_cc($['type'], ($,) => ['state', _p.decide.state($, ($,): t_out.Value.state => {
                            switch ($[0]) {
                                case 'dictionary':
                                    return _p.ss($, ($,) => ({
                                        'option': "dictionary",
                                        'value': ['dictionary', $.__d_map(($,key,) => ['optional', $(($,) => ['set', Value($)], () => ['set', Value($)])])],
                                    }))
                                case 'group':
                                    return _p.ss($, ($,) => ({
                                        'option': "group",
...
export const Document: t_signatures.Document = ($,) => ['group', ['verbose', _p.dictionary.literal(({
    'header': _p.deprecated_cc($['header'], ($,) => ['optional', $(($,) => ['set', Value($)], () => ['set', Value($)])]),
