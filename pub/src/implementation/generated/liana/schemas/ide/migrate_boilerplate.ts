...
export const Text_Edits: t_signatures.Text_Edits = ($) => $.__l_map(($) => _p.deprecated_cc($, ($): t_out.Text_Edits.L => {
    switch ($[0]) {
        ...
        case 'replace': return _p.ss($, ($) => ['replace', ({
...
export const Key_Value_Pairs_To_Be_Sorted: t_signatures.Key_Value_Pairs_To_Be_Sorted = ($) => $.__d_map(($) => $)
