...
// export type Value = pi.Transformer<d_in.Value, d_out.Text>
export type Document = pi.Transformer_With_Parameter<d_in.Document, d_out.Text, { 'indentation': string, 'newline': string }   >
