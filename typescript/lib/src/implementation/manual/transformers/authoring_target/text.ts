...
export type Value = pi.Transformer_With_Parameter<d_in.Value, d_out.Text, Parameters>
export type Document = pi.Transformer_With_Parameter<d_in.Document, d_out.Text, Doc_Parameters>
