...
d_in.Value.type_.concrete, d_out.Value.data.concrete
>
export type ID_Value_Pairs = p_i.Transformer<
d_in.ID_Value_Pairs, d_out.ID_Value_Pairs
>
export type Items = p_i.Transformer<
d_in.Items, d_out.Items
>
export type Structural_Token = p_i.Transformer<
d_in.Structural_Token, d_out.Token_Trivia
>
